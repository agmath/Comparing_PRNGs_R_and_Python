...
def plot_hists(seq_length = 2**14 - 1, max_rand = 99999, rand_seed = 1234):
  ...
  plt.clf()
  plt.hist(sequence_r, bins=50, density=True, alpha=0.5, color='blue', label='Sequence R')
  plt.hist(sequence_py, bins=50, density=True, alpha=0.5, color='red', label='Sequence Python')

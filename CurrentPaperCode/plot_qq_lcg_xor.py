...
def plot_qq_xor_lcg(seq_length = 2**14 - 1, max_rand = 99999, rand_seed_lcg = 1234, a = 1664525, c = 1013904223, m = 2**32, rand_seed_xor1 = 1234, rand_seed_xor2 = 5678):
  ...
  plt.subplot(1, 3, 3)
  stats.probplot(sequence_lcg_scaled, dist="uniform", plot=plt)
  plt.title("Uniform Q-Q Plot (LCG)")
  plt.show()

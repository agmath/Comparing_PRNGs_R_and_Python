...
def plot_scaled_hists_mt_lcg(seq_length = 2**14 - 1, max_rand = 99999, rand_seed = 1234, a = 1664525, c = 1013904223, m = 2**32):
  ...
  plt.clf()
  plt.hist(sequence_mt_scaled, bins=50, density=True, alpha=0.5, color='blue', label='Sequence MT')

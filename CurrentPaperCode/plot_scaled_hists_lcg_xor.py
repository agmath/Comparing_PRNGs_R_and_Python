...
def plot_hists_xor_lcg(seq_length = 2**14 - 1, max_rand = 99999, rand_seed_lcg = 1234, a = 1664525, c = 1013904223, m = 2**32, rand_seed_xor1 = 1234, rand_seed_xor2 = 5678):
  ...
  plt.clf()
  plt.hist(sequence_xor, bins=50, density=True, alpha=0.5, color='blue', label='Sequence XOR')
  plt.hist(sequence_lcg_scaled, bins=50, density=True, alpha=0.5, color='red', label='Sequence LCG')

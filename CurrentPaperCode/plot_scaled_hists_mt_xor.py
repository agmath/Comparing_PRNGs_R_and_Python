...
def plot_scaled_hists(seq_length = 2**14 - 1, max_rand = 99999, rand_seed_mt = 1234, rand_seed_xor1 = 1234, rand_seed_xor2 = 5678):
  ...
  plt.hist(sequence_xor, bins=50, density=True, alpha=0.5, color='red', label='Sequence XOR')
